...
@endphp
        ...
        <div class="tp-contact-area tp-contact-2-style-2 tp-contact-style-3 tp-contact-inner-style p-relative fix">
            <div class="tp-contact-shape-2 d-none d-xl-block">
                <img src="assets/img/shape/blog/shape-4-2.png" alt="">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-5 col-lg-6">
                        <div class="tp-contact-3-left">
                            ...
                            <p>Synergistically scalable platforms. Conveniently visualize installed the online interactive
                                results. Collaboratively is experiences best services applications.</p>
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-6">
