...
{{--                          --}}{{-- @endforeach --}}
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                           <div class="tp-funfact-2-left">
                              <div class="tp-funfact-2-item text-center tp-funfact-style-yellow mb-30">
                                 ...
                                 <h4 class="tp-funfact-2-number"><i class="purecounter" data-purecounter-duration="1"
                                       data-purecounter-end="880">0</i>+</h4>
                                 <span>Gardening Design</span>
                              </div>
   ...
   <!-- brand area end -->
      ...
      <!-- blog area start -->
      <div class="tp-blog-area tp-blog-style-2 tp-blog-style-3 p-relative fix z-index pt-150">
         <div class="tp-blog-shape-2 tp-float-bob-y">
            <img src="assets/img/shape/funfact/shape-3-1.png" alt="">
         </div>
         <div class="container">
            <div class="row">
               <div class="col-xl-12">
                  <div class="tp-blog-title-box text-center mb-60">
                     <h4 class="tp-section-title">Nos derniers aticles</h4>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-xl-12">
                  <div class="tp-blog-wrapper">
                     <div class="swiper-container tp-blog-active-2">
                        <div class="swiper-wrapper">
                           @foreach($posts as $post)
                           <div class="swiper-slide">
                              <div class="tp-blog-item tp-shine">
                                 <div class="tp-blog-thumb mb-5 p-relative">
                                    <a href="#">
                                       <img src="{{ getImage($post) }}" alt="" style="width:550%">
                                    </a>
                                 </div>
                                 <div class="tp-blog-content p-relative z-index-2">
                                    <div class="tp-blog-tag mb-10">
                                       <span>
                                          <svg width="16" height="20" viewBox="0 0 16 20" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                             <path
                                    ...
                                    <h4 class="tp-blog-title mb-5">
                                       <a class="text-anim-3" href="#">{{$post->title}}</a>
                                    </h4>
                                    <p class="mb-0 pb-20">{{$post->meta_description}}</p>
                                    <div class="tp-blog-bottom-box d-flex align-items-center">
                                       <div class="tp-blog-avatar-info d-flex align-items-center">
                                          <div class="tp-blog-avatar">
                                             <img src="assets/img/blog/avatar-1-1.png" alt="">
                                          </div>
                                          <span>{{ $post->user->name }}</span>
                                       </div>
                                       <div class="tp-blog-meta d-none d-lg-block">
                                          <span>
                                             <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
