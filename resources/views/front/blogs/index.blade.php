            ...
            <div class="row">
               <div class="col-xl-12">
                  <div class="tp-blog-title-box text-center mb-60">
                     <span class="tp-section-subtitle">Our Recent Articles</span>
               ...
               <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                  <div class="tp-blog-item">
                     <div class="tp-blog-thumb p-relative">
                        <a  href="{{ url('details-blog', $post->id) }}">
                     ...
                     <div class="tp-blog-content p-relative">
                        <div class="tp-blog-meta mb-15">
                           ...
                           <span>
                              <svg width="16" height="20" viewBox="0 0 16 20" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                 <path
                                    d="M10.4049 11.3006C11.297 11.2726 12.1708 11.0275 12.9583 10.5845C13.7458 10.1415 14.4256 9.51256 14.9448 8.74676C15.4974 7.9471 15.8482 7.01235 15.9642 6.03036C16.0903 4.9923 15.8815 3.93967 15.3715 3.042L15.2944 2.91071L15.17 2.83256C14.3297 2.30375 13.3469 2.08387 12.3755 2.20738C11.4466 2.32163 10.5605 2.68304 9.80034 3.25768C9.53013 3.45898 9.27637 3.68379 9.04172 3.92975C8.72276 3.20889 8.28873 2.55121 7.75858 1.98544C5.81757 -0.0620204 2.92236 -0.596549 0.883556 0.713203L0.762058 0.79135L0.67612 0.932016C-0.565532 3.08263 -0.0587957 6.13664 1.88221 8.1841C3.03662 9.4258 4.60767 10.1388 6.25615 10.169C6.80292 10.1706 7.34631 10.0787 7.86526 9.89709V11.7726H2.95792C2.80073 11.7726 2.64998 11.8385 2.53883 11.9557C2.42768 12.073 2.36524 12.232 2.36524 12.3978V14.5859C2.36524 14.7517 2.42768 14.9108 2.53883 15.028C2.64998 15.1453 2.80073 15.2111 2.95792 15.2111H3.05867V19.3748C3.05867 19.5406 3.12111 19.6996 3.23226 19.8169C3.34341 19.9341 3.49416 20 3.65135 20H14.115C14.2722 20 14.4229 19.9341 14.5341 19.8169C14.6452 19.6996 14.7077 19.5406 14.7077 19.3748V15.2299H14.8114C14.9686 15.2299 15.1193 15.164 15.2305 15.0468C15.3416 14.9295 15.4041 14.7705 15.4041 14.6047V12.4166C15.4041 12.2508 15.3416 12.0917 15.2305 11.9745C15.1193 11.8573 14.9686 11.7914 14.8114 11.7914H9.05061V11.0849C9.48897 11.2292 9.94566 11.302 10.4049 11.3006ZM14.6869 4.44865C14.7633 4.73368 14.8051 5.02778 14.8114 5.3239H13.8542L14.6869 4.44865ZM12.6689 6.57739H14.6484C14.534 6.99178 14.3654 7.38736 14.1476 7.75273H11.5517L12.6689 6.57739ZM10.3663 8.99996H13.0926C12.606 9.44511 12.0261 9.7622 11.4008 9.92521C10.7754 10.0882 10.1223 10.0925 9.49511 9.93773L10.3663 8.99996ZM3.34019 2.63876L2.20226 1.44154C2.57005 1.31604 2.95366 1.24965 3.34019 1.24461V2.63876ZM5.94499 5.38955L4.52554 3.88912V1.3884C5.02698 1.52866 5.5055 1.74785 5.94499 2.03858V5.38955ZM7.13034 6.63991V3.12014C8.31569 4.50804 8.73945 6.35232 8.2742 7.85588L7.13034 6.63991ZM14.2187 13.0292V13.967H3.55059V13.0292H14.2187Z"
                                    fill="currentcolor" />
                              </svg>
                           {{--    Gardening --}}
                           </span>
                        ...
                        <h4 class="tp-blog-title mb-20">
                           <a class="text-anim-3" href="{{ url('details-blog', $post->id) }}">
                            <span>{{ $post->title }}</span>
                           </a>
                        </h4>
                        <a class="tp-btn-border-sm"  href="{{ url('details-blog', $post->id) }}">
                           <span>Read More</span>
                        </a>
                     </div>
                  </div>
