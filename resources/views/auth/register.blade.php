                        ...
                        <form method="POST" action="{{ route('register') }}">
                           ...
                           <div class="row gx-30">
                             ...
                             <div class="col-12 mb-20">
                                ...
                                <div class="tp-contact-input-box p-relative">
                                    <input id="email" type="email" placeholder="Votre mail" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
                                    <span class="tp-contact-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="-13 0 50 30" fill="currentColor">
